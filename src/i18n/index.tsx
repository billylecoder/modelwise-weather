...
const translations = {
  en: {
    ...
    infoTab: "Info",
    newsTab: "Weather News",
    noNews: "No weather news available right now.",
    newsCredit: "News via Google News.",
  ...
  el: {
    ...
    infoTab: "Πληροφορίες",
    newsTab: "Καιρικά Νέα",
    noNews: "Δεν υπάρχουν διαθέσιμα καιρικά νέα.",
    newsCredit: "Νέα μέσω Google News.",
